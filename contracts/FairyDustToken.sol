...
/// @title Fairy Dust Token
///
/// @dev This is the contract for the Fairy Dust governance token.
///
...
contract FairyDustToken is AccessControl, ERC20("Fairy Dust", "DUST") {
  ...
  modifier onlyMinter() {
    require(hasRole(MINTER_ROLE, msg.sender), "FairyDustToken: only minter");
    _;
  }
